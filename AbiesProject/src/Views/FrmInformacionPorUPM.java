	...
	public FrmInformacionPorUPM() {
		...
		list.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				String UPMElegido=(String) list.getSelectedValue();
				lblUPM.setText(UPMElegido);
			}
		});
		list.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		list.setModel(new AbstractListModel() {
			String[] values = new String[] { "6804", "8228", "11284", "11288", "12873", "13659", "14411", "14465",
					"14469", "14471", "15276", "16045", "16105", "16107", "16125", "16127", "16940", "17775", "18505",
					"19362", "20231", "20301", "22779", "22799", "22979", "23841", "23851", "24528", "24708", "28985",
					"28995", "29902", "31729", "31733", "32640", "32650", "41486", "42868", "46176", "47340", "56339",
					"57386", "58427", "58497", "60437", "61437", "61451", "62433", "62453", "63475", "63485", "64480",
					"65505", "65517", "66540", "67549", "68565", "75694", "85825", "90746", "93652", "99246", "102043",
					"102966", "102972", "104822", "105736", "105746", "106670" };
		...
		tblVegetacionPorSitio.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Sitio",
				"Tipo de vegetaci\u00F3n", "Fase sucecional", "Conteo registros", "Conteo Individuos" }));
		...
		table.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Sitio", "Entidad taxonomica", "Forma de vida" }));
		...
		panelDiametrosNormales.setBounds(27, 454, 404, 340);
		layeredPane_1.add(panelDiametrosNormales);

		panelAlturasTotales = new JPanel();
		panelAlturasTotales.setBounds(492, 454, 404, 340);
		layeredPane_1.add(panelAlturasTotales);
