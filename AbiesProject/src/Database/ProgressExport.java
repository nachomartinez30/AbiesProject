...
public class ProgressExport extends SwingWorker<Integer, String> {
	...
	protected Integer doInBackground() throws Exception {
		...
		if (filtroUPM == true) {
			condicionQuery = "WHERE ";
			queryFiltroUpm = "upm.UPMID =";
			int i = 0;
			for (i = 0; i < listUpmsConsultar.size(); i++) {
				if (queryFiltroUpm.equals("upm.UPMID =") == true) {
					queryFiltroUpm = queryFiltroUpm + listUpmsConsultar.get(i);
				} else {
					queryFiltroUpm = queryFiltroUpm + " OR upm.UPMID =" + listUpmsConsultar.get(i);
				}
			}
			// queryFiltroUpm = queryFiltroUpm + ")";
			//System.out.println(queryFiltroUpm);
		} else {
			queryFiltroUpm = "";
		}
	...
	public boolean isFiltroUPM() {
		return filtroUPM;
	}

	public void setFiltroUPM(boolean filtroUPM) {
		this.filtroUPM = filtroUPM;
	}

	public ArrayList<String> getListUpmsConsultar() {
		return listUpmsConsultar;
	}

	public void setListUpmsConsultar(ArrayList<String> listUpmsConsultar) {
		this.listUpmsConsultar = listUpmsConsultar;
	}

	/* cambiar path */ public void exportarUPMs(String ruta) {
		...
		try {
			...
			try {
				...
				/*
				 * writer.write("TipoContacto"); writer.write("Nombre");
				 * writer.write("Direccion"); writer.write("TipoTelefono");
				 * writer.write("NumeroTelefono"); writer.write("TieneCorreo");
				 * writer.write("DireccionCorreo"); writer.write("TieneRadio");
				 * writer.write("Canal"); writer.write("Frecuencia");
	...
	/* cambiar path */ public void exportarArbolado(String ruta) {
		try {
			String faceSucecional = "";
	...
	/* cambiar path */ public void exportarSitios(String ruta) {
		try {
	...
	/* cambiar path */ public void exportarRepoblado(String ruta) {
		try {
	...
	/* cambiar path */ public void exportarRepobladoVegetacionMenor(String ruta) {
		try {
	...
	/* cambiar path */ public void exportarVegetacionMayorGregarios(String ruta) {
		try {
	...
	/* cambiar path */ public void exportarSotobosque(String ruta) {
		try {
	...
	/* cambiar path */ public void exportarVegetacionMayorIndividual(String ruta) {
		try {
	...
	/* cambiar path */ public void exportarVegetacionMenor(String ruta) {
		try {
