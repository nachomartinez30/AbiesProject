...
public class ProgressExport extends SwingWorker<Integer, String> {
	...
	JCheckBox chckbxArbolado, chckbxSitios, chckbxUpms, chckbxRepoblado, chckbxSotobosque, chckbxTodo,
			...
			chckbxVegetacionMayorIndividual, chckbxVegetacionMenor;
	...
	public boolean arbolado, sitios, upms, repoblado, sotobosque, todo, inlcuirCoordenadas, inlcuirProveedores,
			vegetacionMayorGregarios, vegetacionMayorIndividual, vegetacionMenor;
	...
	public ProgressExport(JProgressBar barraProgreso, JLabel etiquetaExportacion, String ruta, String exportPath,
			...
			JCheckBox chckbxVegetacionMayorIndividual, JCheckBox chckbxVegetacionMenor, JButton btnExportar) {
		super();
	...
	protected Integer doInBackground() throws Exception {
		...
		if (upms == true) {
			...
			exportarUPMs(ruta, coordenadasGrl, proveedoresGrl);
			Thread.sleep(800);
			upms = false;
		}
		if (sitios == true) {
			etiquetaExportacion.setText("Exportando: Sitios...");
			exportarSitios(ruta, coordenadasGrl, proveedoresGrl);
			sitios = false;
		}
		if (arbolado == true) {
			etiquetaExportacion.setText("Exportando: Arbolado...");
			exportarArbolado(ruta, coordenadasGrl, proveedoresGrl);
			arbolado = false;
		}
		if (repoblado == true) {
			etiquetaExportacion.setText("Exportando: Repoblado...");
			exportarRepoblado(ruta, coordenadasGrl, proveedoresGrl);
			repoblado = false;
		}

		if (sotobosque == true) {
			etiquetaExportacion.setText("Exportando: Sotobosque...");
			exportarSotobosque(ruta, coordenadasGrl, proveedoresGrl);
			sotobosque = false;
		}
		if(vegetacionMayorIndividual==true) {
			etiquetaExportacion.setText("Exportando: Vegetacion ayor individual...");
			exportarVegetacionMayorIndividual(ruta, coordenadasGrl, proveedoresGrl);
	...
	public void exportarUPMs(String ruta, boolean coordenadas, boolean proveedores) {
	...
	public void exportarArbolado(String ruta, boolean coordenadas, boolean proveedores) {
		try {
	...
	public void exportarSitios(String ruta, boolean coordenadas, boolean proveedores) {
		try {
			String queryCoordenadas = "";
	...
	public void exportarRepoblado(String ruta, boolean coordenadas, boolean proveedores) {
		try {
			String queryProveedores = "";
			String queryCoordenadas = "";
	...
	public void exportarSotobosque(String ruta, boolean coordenadas, boolean proveedores) {
		try {
			String queryProveedores = "";
			String queryCoordenadas = "";
	...
	public void exportarVegetacionMayorIndividual(String ruta, boolean coordenadas, boolean proveedores) {
		try {
			String queryProveedores = "";
			String queryCoordenadas = "";
