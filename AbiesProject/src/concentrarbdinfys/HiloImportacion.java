...
public class HiloImportacion extends SwingWorker<Integer, String> {
	...
	public HiloImportacion(JLabel lblEstatus, JProgressBar pbExportacion, JButton btnEjecutar,File[] baseDatos, JButton btnBuscar, JTextField txtUbicacion,JTextArea txtaMonitoreo) {
