...
public class HiloImportacion extends SwingWorker<Integer, String> {
    ...
    protected Integer doInBackground() {
        ...
        getEtiqueta().setText("Importando EpÃ­fitas..."); 
        ...
        getEtiqueta().setText("Importando FotografÃ­a hemisferica..."); 
        ...
        getEtiqueta().setText("Importando ParÃ¡metros fÃ­sico quÃ­micos..."); 
        ...
        getEtiqueta().setText("Importando CÃ¡rcava..."); 
        ...
        getBarraProgreso().repaint();
        getEtiqueta().setText("Importando Erosión hÃ­drica canalillo..."); 
        ...
        getEtiqueta().setText("Importando longitud montÃ­culo..."); 
        ...
        getEtiqueta().setText("Importando Material leÃ±oso caÃ­do de 100..."); 
        bdImportar.importarCarbonoMaterialLenioso100(this.ruta); //34
        getEtiqueta().setText("Importando Material leÃ±oso caÃ­do de 1000...");
        ...
        getEtiqueta().setText("Importando Colecta botÃ¡nica...");
